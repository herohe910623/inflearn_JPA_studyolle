...
//    }
    ...
    @ResponseBody
    public ResponseEntity studyTagsAdd(@CurrentAccount Account account, @PathVariable String path,
    ...
    @ResponseBody
    public ResponseEntity studyTagsRemove(@CurrentAccount Account account, @PathVariable String path,
                                          @RequestBody TagForm tagForm) {
        Study study = studyService.getStudyToUpdateTag(account, path);
    ...
    @ResponseBody
    public ResponseEntity studyZonesAdd(@CurrentAccount Account account, @PathVariable String path,
    ...
    @ResponseBody
    public ResponseEntity studyZonesRemove(@CurrentAccount Account account, @PathVariable String path,
                                           @RequestBody ZoneForm zoneForm) {
        Study study = studyService.getStudyToUpdateZone(account, path);
        Zone zone = zoneRepository.findByCityAndProvince(zoneForm.getCityName(), zoneForm.getProvinceName());
        if (zone == null) {
    ...
    @GetMapping("/study")
    public String settingStudyForm(@CurrentAccount Account account, @PathVariable String path, Model model) {
        Study study = studyService.getStudyToUpdate(account, path);
        model.addAttribute(account);
        model.addAttribute(study);
